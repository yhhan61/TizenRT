...
#ifndef __ARCH_ARM_SRC_RP0W_INCLUDE_FOTA_H__
#define __ARCH_ARM_SRC_RP0W_INCLUDE_FOTA_H__
 ...
 *
 * Description:
 *   Intialize FOTA for rp0w
 *
 ****************************************************************************/
int rp0w_fota_init(void);

/****************************************************************************
 * Name: rp0w_fota_update_notify
 *
 * Description:
 *   Notify if fota update done in previous boot
 *
 ****************************************************************************/
int rp0w_fota_update_notify(void);

#endif

#endif							/* __ARCH_ARM_SRC_RP0W_INCLUDE_FOTA_H__ */
